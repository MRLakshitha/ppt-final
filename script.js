...
rotateSelectedElement() {
    ...
    element.rotation = (element.rotation || 0) + 15;
...
if (transform) style += `transform:${transform.trim()};transform-origin:center;`;
        ...
        const a = document.createElement('a');
            ...
            let filename =prompt("Enter the fle name" ,"presentation.html");
            if(!filename) {
...
showQuickActionMenu(x, y, width, height) {
    ...
    menu.addEventListener('click', (e) => {
        ...
        if (action) {
            switch(action) {
                case 'text':
                    this.addTextElement('Double click to edit', x, y, width, height);
                    break;
                case 'image':
...
initContextMenu() {
    ...
    contextMenu.addEventListener('click', (e) => {
        ...
        switch(action) {
            ...
            // Empty area actions
            case 'addtext':
                this.addTextElement('Double click to edit', e.clientX, e.clientY);
                break;
            case 'addimage':
